...
// Load categories
$query_categories = "SELECT theme,id FROM categories;";
...
// // Categories id
// $query_categories_id = "SELECT id FROM categories;";
// $result_categories_id = $connection->query($query_categories_id);
// $categories_id = array();
// while($row = $result_categories_id->fetch_assoc()) {
// 	$categories_id[] = $row; 
// }
// // Categories id - end
				...
				<div id="nav-fixed">
					<div class="container">
						...
						<ul class="nav-menu nav navbar-nav">
							...
							?>
							<li class="cat-<?=$i?>"><a href="category.php?id=<?php echo $cate['id']; ?>"><?php echo $cate['theme']; ?></a></li>
							<?php 
								$i++;
								if($i == 5) $i=1;
								}
